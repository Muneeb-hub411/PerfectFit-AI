        ...
        <div className="bg-white/[0.06] backdrop-blur-2xl border border-white/[0.12] rounded-3xl p-10 shadow-[0_32px_80px_rgba(0,0,0,0.6)]">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-white text-2xl font-bold tracking-tight">PerfectFit</span>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex justify-end">
              <a href="#" className="text-[13px] text-white/30 hover:text-violet-400 transition-colors duration-200">
                Forgot password?
              </a>
            </div>
          ...
          <div className="flex items-center gap-4 my-7">
            ...
            <span className="text-[11px] text-white/20 tracking-wider uppercase">New here?</span>
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 group-hover:text-violet-400 transition-colors" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
